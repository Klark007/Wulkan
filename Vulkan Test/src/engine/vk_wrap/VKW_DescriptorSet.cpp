...
void VKW_DescriptorSet::init(VKW_Device* vkw_device, const VKW_DescriptorPool* vkw_pool, VKW_DescriptorSetLayout layout)
{
	device = vkw_device;
	pool = vkw_pool;
...
void VKW_DescriptorSet::update(uint32_t binding, Texture& texture, const VKW_Sampler& sampler, VkImageAspectFlags aspect) const
{
